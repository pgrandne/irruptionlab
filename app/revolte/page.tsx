...
const Revolte = () => (
    <>
        ...
        <p className="text-justify text-[20px] mt-10 px-10 md:px-44">Join the Web3 revolution with <i>Revolte! </i> <br /><br />
        ...
        <Link href="https://www.revolte.app/" target="_blank" rel="noopener noreferrer" className="flex justify-center items-center opacity-80 hover:opacity-100">
        <div className="">
            <Image
        ...
        <ul className="text-justify mt-10  px-10 md:px-44 list-disc list-inside">With this adventure game we’re trying to help people get into web3 without scaring them off with all the complicated technical stuff.<br /><br />
        ...
        <li>Chapter 1 is live! It leads to the installation of the wallet for the new comers. The purpose of this chapter is to introduce the story and make the world we’ve created feel more real and interesting.</li><br />
        <li>Chapter 2: this one is for the users to experiment (on the testnet) the basics of web3, like making a transaction, swap, using a bridge, nft…This chapter (split in several episodes) will be developed from March to April 2023. Some episodes have already been released.</li><br />
