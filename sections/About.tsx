        ...
        <section className={`${styles.paddings} relative z-10`}>
            ...
            >
                ...
                >
                    ...
                    <span className="font-extrabold">Irruption Lab</span>{' '}builds apps that could help onboard new comers. <br /><br />We develop easy-to-access dapps (decentralized applications) with real interest in real life. <br /><br />Our aim is to allow everyone to have access to this technology and all its opportunities. <br /><br />All our work is open source.
                </motion.p>
                <motion.img
